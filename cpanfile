...
requires 'Dist::Zilla::Plugin::License', 0.03;
requires 'Dist::Zilla::Plugin::LicenseFromModule', 0.02; # override_author = 1
...
requires 'Dist::Zilla::Plugin::ReversionOnRelease', '0.03';
